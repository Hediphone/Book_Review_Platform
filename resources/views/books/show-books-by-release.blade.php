...
<nav aria-label="breadcrumb" class="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="browse">Browse Books</a></li>
        <li class="breadcrumb-item active" aria-current="page">Latest Releases</li>
    </ol>
</nav>
...
<section class="latest-books-section">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="text-left">Latest Releases</h3>
        </div>
                        ...
                        <a href="{{ route('books.bookDetail', ['genre' => $book->genre, 'id' => $book->bookID]) }}">
                            ...
                            <div class="card-body">
                                ...
                                <p class="release-date">
                                    {{ \Carbon\Carbon::parse($book->release_date)->format('F d, Y') }}
                                </p>
