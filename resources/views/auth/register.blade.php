        ...
        <div class="row">
            ...
            <form class="login_form" method="POST" action="{{route("register.post")}}">
                ...
                <div class="input_container">
                    ...
                    <input type="text" name="fullname" placeholder="Enter Your Full Name" class="input_field" required>
                ...
                <div class="input_container">
                    <i class="fas fa-user icon"></i>
                    <input type="text" name="email" placeholder="Enter Your Email" class="input_field" required>
                    @if($errors->has('email'))
                ...
                <div class="input_container">
                    ...
                    <input type="password" name="password" placeholder="Create Password" class="input_field password_field" required>
            ...
            <div class="social-icons text-center mt-3">
                ...
                <a href="#" class="mx-3">
                    <img src="{{ asset('assets/images/login/x.svg') }}" alt="Profile" class="x-logo"></i>
                </a>
            </div>
            <div class="row">
                <div class="left-image-container">
                    <img src="{{ asset('assets/images/login/front.svg') }}" alt="Profile" class="left-image">
                </div>
            </div>
